...
void AssetManager::load()
{
    ...
    loadTexture("level_grass_tiles", "levels/grass/tiles_sheet.png");
    loadTexture("level_desert_tiles", "levels/desert/tiles_sheet.png");
    loadTexture("level_ice_tiles", "levels/ice/tiles_sheet.png");
    loadTexture("level_castle_tiles", "levels/castle/tiles_sheet.png");
    loadTexture("level_lava_tiles", "levels/lava/tiles_sheet.png");
    loadTexture("level_grass_pipes", "levels/grass/pipes_sheet.png");
    loadTexture("level_desert_pipes", "levels/desert/pipes_sheet.png");
    loadTexture("level_ice_pipes", "levels/ice/pipes_sheet.png");
    loadTexture("level_castle_pipes", "levels/castle/pipes_sheet.png");
    loadTexture("level_lava_pipes", "levels/lava/pipes_sheet.png");
