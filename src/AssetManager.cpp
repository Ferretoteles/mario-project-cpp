...
void AssetManager::load()
{
    ...
    loadTextureWithColorKey("level_grass_inner", "levels/grass/inner_block.png", 18);
    loadTextureWithColorKey("level_desert_inner", "levels/desert/inner_block.png", 18);
    loadTextureWithColorKey("level_ice_inner", "levels/ice/inner_block.png", 18);
    loadTextureWithColorKey("level_castle_inner", "levels/castle/inner_block.png", 18);
    loadTextureWithColorKey("level_lava_inner", "levels/lava/inner_block.png", 18);
